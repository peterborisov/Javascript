...
(function (scope) {
	...
	function generateData() {
		...
		var review1 = imdb.getReview('Jiko Jikov', 'Mnou qk film', new Date(2014, 9, 23));
		var review2 = imdb.getReview('Mincho Minchev', 'Kopele she sa razcepish', new Date(2014, 9, 23));
		var review3 = imdb.getReview('Marko Markov', 'Mnogo rev. Nqma takava boza.', new Date(2014, 9, 23));
		var review4 = imdb.getReview('Geco Cecov', 'Stava za vendyj na rabota', new Date(2014, 9, 23));
		var review5 = imdb.getReview('Shuri Shurev', 'Maina, gledai go, che i ti da si zagubish vremeto', new Date(2014, 9, 23));
		var review6 = imdb.getReview('Trapo Trapov', 'Ot typ po typ', new Date(2014, 9, 23));
		var review7 = imdb.getReview('Geno Genov', 'Tiq ot IMDB reitinga im kuca neshto', new Date(2014, 9, 23));
		var review8 = imdb.getReview('Dimka Dimka', 'Gledam go za 3ti pyt i nishto ne shvashtam', new Date(2014, 9, 23));
		var review9 = imdb.getReview('Maca Maca', 'Brato mnogo si typ, bace.', new Date(2014, 9, 23));
		var review10 = imdb.getReview('Tiro Tiro', 'Nqma takyv film. Za sefte mi e.', new Date(2014, 9, 23));
		var review11 = imdb.getReview('Haralampi Haralampiev', 'Hubav film', new Date(2014, 9, 23));
		var review12 = imdb.getReview('Trabi Trabi', 'Gotino parche taq macka', new Date(2014, 9, 23));
		var review13 = imdb.getReview('Shina Shina', 'Na aktiora she mu skocha ako go nabaram', new Date(2014, 9, 23));
